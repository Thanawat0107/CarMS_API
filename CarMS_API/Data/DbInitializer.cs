        ...
        private static void SeedData(ApplicationDbContext context)
        {
            ...
            var cars = new List<Car>
            {
                new Car
                {
                    ...
                    CarImages = new List<string> { "https://cdn.pixabay.com/photo/2019/08/04/23/28/honda-4384888_1280.jpg" },
                    ...
                    Act = "Has valid insurance",
                    ApprovalRemark = "Approved - excellent condition",
                    ApprovedAt = new DateTime(2023, 5, 11)
                },
                new Car
                {
                    ...
                    CarImages = new List<string> { "https://cdn.pixabay.com/photo/2014/07/13/19/45/edsel-ranger-392745_1280.jpg" },
                    CreatedAt = new DateTime(2023, 6, 5),
                    UpdatedAt = new DateTime(2024, 1, 10),
                    CarStatus = SD.Status_Sold,
                    IsUsed = true,
                    IsDeleted = false,
                    IsCollisionHistory = true,
                    Insurance = "Third Party",
                    Act = "Previous accident on record",
                    ApprovalRemark = "Pending review - minor damage history",
                    ApprovedAt = null
                },
                new Car
                {
                    ...
                    CarImages = new List<string> { "https://cdn.pixabay.com/photo/2023/01/02/09/21/super-car-7691660_1280.jpg" },
                    ...
                    IsDeleted = false,
                    IsCollisionHistory = false,
                    Insurance = "Full Coverage Plus",
                    Act = "Clean record",
                    ApprovalRemark = "Approved - new vehicle",
                    ApprovedAt = new DateTime(2024, 3, 2)
                },
                new Car
                {
                    ...
                    CarImages = new List<string> { "https://cdn.pixabay.com/photo/2017/04/21/02/20/jdm-2247450_1280.jpg" },
                    ...
                    Act = "Minor collision history",
                    ApprovalRemark = "Pending verification",
                    ApprovedAt = null
                },
                new Car
                {
                    ...
                    CarImages = new List<string> { "https://cdn.pixabay.com/photo/2022/03/27/16/11/car-7095541_1280.jpg" },
                    ...
                    Insurance = "Full Coverage",
                    Act = "Clean record",
                    ApprovalRemark = "Approved - excellent hybrid vehicle",
                    ApprovedAt = new DateTime(2023, 1, 21)
                },
                new Car
                {
                    ...
                    CarImages = new List<string> { "https://cdn.pixabay.com/photo/2020/06/06/01/44/bmw-x5-5264945_1280.jpg" },
                    ...
                    Act = "Clean record",
                    ApprovalRemark = "Approved - luxury vehicle",
                    ApprovedAt = new DateTime(2023, 3, 16)
                },
                new Car
                {
                    BrandId = brandMap["Toyota"],
                    ...
                    CarImages = new List<string> { "https://cdn.pixabay.com/photo/2021/10/29/12/26/toyota-gr-yaris-6751759_1280.jpg" },
                    ...
                    IsCollisionHistory = true,
                    Insurance = "Third Party",
                    Act = "Minor accident reported",
                    ApprovalRemark = "Under review",
                    ApprovedAt = null
                },
                new Car
                {
                    ...
                    CarImages = new List<string> { "https://cdn.pixabay.com/photo/2017/03/24/21/44/mustang-2172273_1280.jpg" },
                    ...
                    Insurance = "Full Coverage",
                    Act = "Clean record",
                    ApprovalRemark = "Approved - sports car",
                    ApprovedAt = new DateTime(2024, 4, 9)
                },
                new Car
                {
                    BrandId = brandMap["Toyota"],
                    ...
                    CarImages = new List<string> { "https://cdn.pixabay.com/photo/2016/05/12/19/23/mexico-1388435_1280.jpg" },
                    ...
                    Act = "Previous service records available",
                    ApprovalRemark = "Pending inspection",
                    ApprovedAt = null
                },
                new Car
                {
                    ...
                    CarImages = new List<string> { "https://cdn.pixabay.com/photo/2017/09/14/07/08/mitsubishi-2748155_1280.jpg" },
